...
public class HumanWarden extends GeneralHumanoidMob {
	...
	public static final RegistryObject<EntityType<HumanWarden>> TYPE = newType(HumanWarden.class, Humanoid.HUMANOID_WIDTH, Humanoid.HUMANOID_HEIGHT, TYPE_NAME, WardenTrait.ATTRIBUTES);
